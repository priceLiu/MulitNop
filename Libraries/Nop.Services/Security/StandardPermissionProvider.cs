...
namespace Nop.Services.Security
{
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        //add by hz
        public static readonly PermissionRecord ManageVendor = new PermissionRecord { Name = "Manage Vendor", SystemName = "ManageVendor", Category = "Customer" };
        //end by hz
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[] 
            {
                ...
                new DefaultPermissionRecord 
                {
                 ...
                 //add by hz  - install permission to store manager
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = SystemCustomerRoleNames.VendorManager,
                    PermissionRecords = new[] 
                    {
                        AccessAdminPanel,
                        ManageVendor, //add by hz
