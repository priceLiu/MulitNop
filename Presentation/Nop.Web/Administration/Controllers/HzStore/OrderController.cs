...
namespace Nop.Admin.Controllers
{
	...
	public partial class OrderController : BaseNopController
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            //add by hz
            if (_orderService.GetVendorIdByOrderId(id) != customerVendorId && customerVendorId > 0 )
                return AccessDeniedView();
            //end by hz
        ...
        public ActionResult PdfInvoice(int orderId)
        {
            ...
            //add by hz
            if (_orderService.GetVendorIdByOrderId(orderId) != customerVendorId && customerVendorId > 0)
                return AccessDeniedView();
            //end by hz
        ...
        public ActionResult ShipmentDetails(int id)//add by hz to do
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageOrders)
                && !_permissionService.Authorize(StandardPermissionProvider.ManageVendor) //add by hz 
                )
        ...
        [HttpPost]
        public ActionResult DeleteShipment(int id)//add by hz to do
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageOrders)
                && !_permissionService.Authorize(StandardPermissionProvider.ManageVendor) //add by hz 
                )
        ...
        public ActionResult SetAsShipped(int id)//add by hz to do
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageOrders)
                && !_permissionService.Authorize(StandardPermissionProvider.ManageVendor) //add by hz 
                )
        ...
        public ActionResult SetAsDelivered(int id)//add by hz to do
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageOrders)
                && !_permissionService.Authorize(StandardPermissionProvider.ManageVendor) //add by hz 
                )
        ...
        public ActionResult PdfPackagingSlip(int shipmentId)//add by hz to do
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageOrders)
                && !_permissionService.Authorize(StandardPermissionProvider.ManageVendor) //add by hz 
                )
        ...
        protected virtual IList<OrderIncompleteReportLineModel> GetOrderIncompleteReportModel()
        {
            ...
            //not paid
            var psPending = _orderReportService.GetOrderAverageReportLine(null, PaymentStatus.Pending, null, null, null, null,
                customerVendorId,// add by hz               
                true);
            ...
            //not shipped
            var ssPending = _orderReportService.GetOrderAverageReportLine(null, null, ShippingStatus.NotYetShipped, null, null, null
                , customerVendorId// add by hz
                , true);
            model.Add(new OrderIncompleteReportLineModel()
            {
            ...
            //pending
            var osPending = _orderReportService.GetOrderAverageReportLine(OrderStatus.Pending, null, null, null, null, null
                , customerVendorId// add by hz
                , true);
            model.Add(new OrderIncompleteReportLineModel()
            {
