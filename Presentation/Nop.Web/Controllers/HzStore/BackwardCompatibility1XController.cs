    ...
    public partial class BackwardCompatibility1XController : BaseNopController
    {
        ...
        public ActionResult GeneralRedirect()
        {
            ...
            switch (aspxfileName)
            {
                ...
                case "vendor":
                    {
                        return RedirectVendor(Request.QueryString["vendorid"], false);
                    }
                //end by hz
                default:
                    break;
        ...
        //add by hz
        public ActionResult RedirectVendor(string id, bool idIncludesSename = true)
        {
            //we can't use dash in MVC
            var vendorId = idIncludesSename ? Convert.ToInt32(id.Split(new char[] { '-' })[0]) : Convert.ToInt32(id);
