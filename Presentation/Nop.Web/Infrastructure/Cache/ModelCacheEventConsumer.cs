...
namespace Nop.Web.Infrastructure.Cache
{
    ...
    public partial class ModelCacheEventConsumer: 
        ...
        //product vendors
        IConsumer<EntityInserted<ProductVendor>>,
        IConsumer<EntityUpdated<ProductVendor>>,
        IConsumer<EntityDeleted<ProductVendor>>,
        //Vendor templates
        IConsumer<EntityInserted<VendorTemplate>>,
        IConsumer<EntityUpdated<VendorTemplate>>,
        IConsumer<EntityDeleted<VendorTemplate>>
        //end by hz
    {
        /// <summary>
        ...
        /// {1} : language id
        /// </remarks>
        public const string VENDOR_NAVIGATION_MODEL_KEY = "Nop.pres.vendor.navigation-{0}-{1}-{2}";
        ...
        //add by hz
        /// <summary>
        /// Key for ProductVendors model caching
        /// </summary>
        /// <remarks>
        /// {0} : product id
        /// {1} : language id
        /// </remarks>
        public const string PRODUCT_VENDORS_MODEL_KEY = "Nop.pres.product.vendors-{0}-{1}";
        public const string PRODUCT_VENDORS_PATTERN_KEY = "Nop.pres.product.vendors";
        //end by hz
        ...
        //add by hz
        /// <summary>
        /// Key for VendorTemplate caching
        /// </summary>
        /// <remarks>
        /// {0} : vendor template id
        /// </remarks>
        public const string VENDOR_TEMPLATE_MODEL_KEY = "Nop.pres.vendortemplate-{0}";
        public const string VENDOR_TEMPLATE_PATTERN_KEY = "Nop.pres.vendortemplate";
        //end by hz
        ...
        /// {4} : is connection SSL secured?
        /// </remarks>
        public const string VENDOR_PICTURE_MODEL_KEY = "Nop.pres.vendor.picture-{0}-{1}-{2}-{3}-{4}";
        ...
        public void HandleEvent(EntityInserted<Language> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(VENDOR_NAVIGATION_PATTERN_KEY);//add by hz
            ...
            _cacheManager.RemoveByPattern(PRODUCT_VENDORS_PATTERN_KEY);//add by hz
        ...
        public void HandleEvent(EntityUpdated<Setting> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(VENDOR_NAVIGATION_PATTERN_KEY); //depends on CatalogSettings.VendorsBlockItemsToDisplay //add  by hz
        ...
        public void HandleEvent(EntityInserted<Vendor> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(PRODUCT_VENDORS_PATTERN_KEY);
        }
        ...
        //product vendors
        public void HandleEvent(EntityInserted<ProductVendor> eventMessage)
        {
            _cacheManager.RemoveByPattern(PRODUCT_VENDORS_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<ProductVendor> eventMessage)
        {
            _cacheManager.RemoveByPattern(PRODUCT_VENDORS_PATTERN_KEY);
        }
        public void HandleEvent(EntityDeleted<ProductVendor> eventMessage)
        {
            _cacheManager.RemoveByPattern(PRODUCT_VENDORS_PATTERN_KEY);
        }
        //end by hz
        ...
        //add by hz
        //Vendor templates
        public void HandleEvent(EntityInserted<VendorTemplate> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_TEMPLATE_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<VendorTemplate> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_TEMPLATE_PATTERN_KEY);
        }
        public void HandleEvent(EntityDeleted<VendorTemplate> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_TEMPLATE_PATTERN_KEY);
        }
        //end by hz
        ...
        public void HandleEvent(EntityInserted<Picture> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(CATEGORY_PICTURE_PATTERN_KEY);
            _cacheManager.RemoveByPattern(MANUFACTURER_PICTURE_PATTERN_KEY);
            _cacheManager.RemoveByPattern(VENDOR_PICTURE_PATTERN_KEY);//add by hz
            _cacheManager.RemoveByPattern(CART_PICTURE_PATTERN_KEY);
        }
